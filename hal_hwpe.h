...
static inline void coeff_1(unsigned int value) {
  HWPE_WRITE(value, COEFF_1);
}
static inline void coeff_2(unsigned int value) {
  HWPE_WRITE(value, COEFF_2);
}
static inline void coeff_3(unsigned int value) {
  HWPE_WRITE(value, COEFF_3);
}
static inline void coeff_4(unsigned int value) {
  HWPE_WRITE(value, COEFF_4);
}
static inline void coeff_5(unsigned int value) {
  HWPE_WRITE(value, COEFF_5);
}
static inline void coeff_6(unsigned int value) {
  HWPE_WRITE(value, COEFF_6);
}
